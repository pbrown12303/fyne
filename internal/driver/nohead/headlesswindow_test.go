...
// 	winW, winH := w.(*headlessWindow).minSizeOnScreen()
...
// 	width, _ := w.(*headlessWindow).minSizeOnScreen()
...
// 		w := d.CreateWindow("test").(*headlessWindow)
// 		w.create()
// 		onIntercepted := false
// 		onClosed := false
...
// 	w := createWindow("Full").(*headlessWindow)
