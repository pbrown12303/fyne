...
// func TestHeadlessCanvas_Focus(t *testing.T) {
// 	w := createWindow("Test")
// 	w.SetPadded(false)
// 	c := w.Canvas().(*HeadlessCanvas)
...
// func TestHeadlessCanvas_Focus_BeforeVisible(t *testing.T) {
// 	w := createWindow("Test")
// 	w.SetPadded(false)
// 	e := widget.NewEntry()
// 	c := w.Canvas().(*HeadlessCanvas)
...
// func TestHeadlessCanvas_Focus_SetContent(t *testing.T) {
// 	w := createWindow("Test")
// 	w.SetPadded(false)
// 	e := widget.NewEntry()
...
// func TestHeadlessCanvas_FocusHandlingWhenAddingAndRemovingOverlays(t *testing.T) {
// 	w := createWindow("Test")
// 	w.SetPadded(false)
// 	c := w.Canvas().(*HeadlessCanvas)
...
func TestHeadlessCanvas_Resize(t *testing.T) {
	...
	w.SetContent(content)
	ensureCanvasSize(t, w.(*headlessWindow), fyne.NewSize(69, 36))

	size := fyne.NewSize(200, 100)
	assert.NotEqual(t, size, content.Size())

	w.Resize(size)
	ensureCanvasSize(t, w.(*headlessWindow), size)
...
func TestHeadlessCanvas_ResizeWithModalPopUpOverlay(t *testing.T) {
	...
	w.Resize(winSize)
	ensureCanvasSize(t, w.(*headlessWindow), winSize)
